...
<table bordercolor="#66b2b2">
  ...
  <a href="https://food-off.onrender.com/" target="_blank">
    <img src="https://img.shields.io/static/v1?label=|&message=WEBSITE&color=cdf998&style=plastic&logo=wordpress&logo-color=white"/>
        ...
        <p><strong>React, CSS, JavaScript, Node.js, Express, MongoDB</strong> - Having trouble deciding what to have for dinner tonight? Choose between two eateries, and narrow it down to a single winner!</p>
    </td>
